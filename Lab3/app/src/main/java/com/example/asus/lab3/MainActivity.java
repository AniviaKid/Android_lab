...
public class MainActivity extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listView=(ListView)findViewById(R.id.shopcar);
        listView.setAdapter(new SimpleAdapter(this,list,R.layout.list_item,new String[]{"icon","name","price"},new int[]{R.id.icon,R.id.text,R.id.price}));
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if(position!=0){
                    ...
                    talk1.setTitle("移除商品");
                    talk1.setMessage("从购物车移除"+name[position]);
                    ...
                    talk1.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            listView.setAdapter(new SimpleAdapter(MainActivity.this,list,R.layout.list_item,new String[]{"icon","name","price"},new int[]{R.id.icon,R.id.text,R.id.price}));
                        }
                    });
                    talk1.show();
                }
